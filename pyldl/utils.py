...
def create_minibatches(datax, datay, batch_size):
    m = datax.shape[0]
    permutation = list(np.random.permutation(m))
    shuffled_X = datax[permutation, :]
    shuffled_Y = datay[permutation, :]
    minibatches = []
    ...
    if m % batch_size != 0:
        ...
        minibatches.append((last_minibatch_X, last_minibatch_Y))
